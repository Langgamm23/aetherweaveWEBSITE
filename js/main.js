...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------------------------------------------------------------------
     13. AI HELPER DRAWER
     --------------------------------------------------------------------- */
  const agoraChat = window.agoraChat || {
    formatMessage: (str) => escapeHtml(str),
    sendMessage: async (text) => "I'm your AI assistant for Aetherweave. How can I help you today with hardware, software development, troubleshooting, or general discussions?",
    clearHistory: () => {}
  };
